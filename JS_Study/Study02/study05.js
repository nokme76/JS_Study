...
console.log();
// toExponential() : 숫자 데이터를 지  수표기법으로 변환, 반올림으로 동작함
//  사용법 : 숫자데이터.toExponential(표시할 자리수);
let num2 = 9.654;
console.log(`원본데이터 : ${num2}`);
...
console.log(`원본데이터 : ${num2}`);
console.log(`toFixed(0)을 넣었을 때 : ${num2.toFixed(0)}`);
console.log(`toFixed(2)을 넣었을 때 : ${num2.toFixed(2)}`);
console.log(`toFixed(4)을 넣었을 때 : ${num2.toFixed(4)}`);

console.log();
// NaN : Not a Number 의 약자 즉 숫자가 아니라는 뜻
// isNaN() : 지정한 데이터가 숫자인지 아닌지를 확인하는 명령어, 숫자가 아니면 true, 숫자면 false
//  사용법 : 변수 = inNaN(데이터);
const num3 = "1234";
const num4 = "12삼사";
...
console.log();
// Number() : 문자열 데이터 타입 숫자를 숫자형 데이터 타입으로 변환, 변환이 불가능할 경우 NaN 이라는 데이터 타입을 반환
//  사용법 : 변수 = Number(데이터);
...
console.log();
// parseInt() : 문자열 데이터 타입 숫자를 정수 데이터로 변환, 변환이 불가능할 경우 NaN 이라는 데이터 타입을 반환
//  사용법 : 변수 = parseInt(데이터);
...
console.log();
// parseFloat() : 문자열 데이터 타입 숫자를 실수 데이터로 변환, 변환이 불가능할 경우 NaN 이라는 데이터 타입을 반환
